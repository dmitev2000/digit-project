  ...
  return (
    <>
      ...
      >
        ...
        ></img>
        <h2>
          <strong>Inclusion & Diversity</strong>
        </h2>
        <p>
        ...
        <p>
          TWe put our partners (employees) first, empowering them by providing
          meaningful opportunities to pursue their aspirations.
        </p>
        <img
        ...
        <p>
          {" "}
          Across the globe, we serve to strengthen each community we are part of
          by being the neighbor every neighborhood wants.
        </p>
        <img
